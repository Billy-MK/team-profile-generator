    ...
    newIntern() {
        ...
        this.managers.forEach(manager => {
            ...
            `<div class="card text-white bg-primary">
                <div class="card-header" id="card-header">Manager - ${manager.name}
                </div>
        ...
        this.engineers.forEach(engineer => {
            ...
            `<div class="card text-white bg-info">
                <div class="card-header" id="card-header">Engineer - ${engineer.name}
                </div>
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item" id="variable">Github: <a href="https://github.com/${engineer.github}">${engineer.github}</a></li>
                </ul>
            </div>`
            cards.push(card);
        })
        this.interns.forEach(intern => {
            ...
            `<div class="card text-white bg-secondary">
                <div class="card-header" id="card-header">Intern - ${intern.name}
                </div>
                <ul class="list-group list-group-flush">
